...
public final class Constants {
    public static int slideGroundLevelTicks = 0;
    public static int lowJunctionSlideTicks = 1220;
    public static int middleJunctionSlideTicks = 2140;
    public static int highJunctionSlideTicks = 3015;
    public static int coneBaseHeightTicks = 0;

    public static int coneHeight2 = 25;
    public static int coneHeight3 = 50;
    public static int coneHeight4 = 100;
    public static int coneHeight5 = 180;

    public static double slideTicksPerMM = 1.25;
    public static double groundHeight = 10;




    public static final int lasySusanForward = 0;
    public static final int lasySusanLeft = -225;
    public static final int lasySusanRight = 225;


    public static final double clawServoOpenPosition = 0.28;
